...
class FormattedYAML(YAML):
    """A YAML loader/dumper that handles distronode content better by default."""
    ...
    def version(self) -> tuple[int, int] | None:
        ...
        Distronode uses PyYAML which only supports YAML 1.1. ruamel.yaml defaults to 1.2.
        So, we have to make sure we dump yaml files using YAML 1.1.
        We can relax the version requirement once distronode uses a version of PyYAML

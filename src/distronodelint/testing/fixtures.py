...
pytest_plugins = ['distronodelint.testing']
"""
...
from distronodelint.constants import DEFAULT_RULESDIR
...
def fixture_default_rules_collection() -> RulesCollection:
    ...
    # That is instantiated very often and do want to avoid distronode-galaxy

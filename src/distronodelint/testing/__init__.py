"""Test utils for distronode-lint."""
...
class RunFromText:
    ...
    def __init__(self, collection: RulesCollection) -> None:
        ...
        # Emulate command line execution initialization as without it Distronode module
...
def run_distronode_lint(
    *argv: str | Path,
    ...
    """Run distronode-lint on a given path and returns its output."""
    ...
    if not executable:
        ...
        args = [sys.executable, "-m", "distronodelint", *args]
    else:

...
class BaseRule:
    ...
    def __repr__(self) -> str:
        """Return a DistronodeLintRule instance representation."""
        return self.id + ": " + self.shortdesc
    ...
    def ids(cls) -> dict[str, str]:
        ...
        This is used by the ``--list-tags`` option to distronode-lint.
        """
...
class DistronodeParserErrorRule(BaseRule):
    """DistronodeParserError."""

    id = "parser-error"
    description = "Distronode parser fails; this usually indicates an invalid file."
    severity = "VERY_HIGH"
    tags = ["core"]
    version_added = "v5.0.0"
    _order = 0

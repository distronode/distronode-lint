"""Utilities for mocking distronode modules and roles."""
...
from distronodelint.constants import DISTRONODE_MOCKED_MODULE, RC
...
def _write_module_stub(
    ...
    body = DISTRONODE_MOCKED_MODULE.format(
        name=name,
        collection=collection,
        namespace=namespace,
    )

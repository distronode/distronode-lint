...
from distronodelint.config import LOOP_VAR_PREFIX, options
from distronodelint.rules import DistronodeLintRule
from distronodelint.text import toidentifier
...
class RoleLoopVarPrefix(DistronodeLintRule):
    """Role loop_var should use configured prefix."""

    id = "loop-var-prefix"
    link = (
        "https://docs.distronode.com/distronode/latest/playbook_guide/"

...
"""NoLogPasswordsRule used with distronode-lint."""
...
from distronodelint.rules import DistronodeLintRule, RulesCollection, TransformMixin
from distronodelint.runner import get_matches
from distronodelint.transformer import Transformer
from distronodelint.utils import Task, convert_to_boolean
...
class NoLogPasswordsRule(DistronodeLintRule, TransformMixin):
    ...
    def matchtask(
        ...
        if task["action"]["__distronode_module_original__"] == "distronode.builtin.user" and (

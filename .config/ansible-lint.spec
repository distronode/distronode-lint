...
Release:        1%{?dist}
Summary:        Distronode-lint checks distronode content for common mistakes

License:        GPL-3.0-or-later AND MIT
URL:            https://github.com/distronode/distronode-lint
Source0:        %{pypi_source}
...
%description
Distronode-lint checks distronode content for practices and behaviors that could
...
%install
%pyproject_install
%pyproject_save_files distronodelint


%check
# Don't try to import tests that import pytest which isn't available at runtime
%pyproject_check_import -e 'distronodelint.testing*' -e 'distronodelint.rules.conftest'
%if %{with check}
%pytest \
  -v \

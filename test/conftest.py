...
from distronodelint.testing.fixtures import *  # noqa: F403
from distronodelint.yaml_utils import FormattedYAML
...
def regenerate_formatting_fixtures() -> None:
    ...
    # Writing fixtures with distronodelint.yaml_utils.FormattedYAML()

...
from distronodelint.formatters import CodeclimateJSONFormatter
...
class TestCodeclimateJSONFormatter:
    ...
    def test_result_is_json(self) -> None:
        ...
        json.loads(output)
        # https://github.com/distronode/distronode-navigator/issues/1490
        assert "\n" not in output

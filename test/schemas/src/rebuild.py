...
if __name__ == "__main__":
    ...
    with Path("f/distronode.json").open(encoding="utf-8") as f:
    ...
    for subschema in ["tasks", "playbook"]:
        ...
        for key, value in combined_json["$defs"][subschema].items():
            sub_json[key] = value
        sub_json["$comment"] = "Generated from distronode.json, do not edit."
        sub_json[
            "$id"
        ] = f"https://raw.githubusercontent.com/distronode/distronode-lint/main/src/distronodelint/schemas/{subschema}.json"

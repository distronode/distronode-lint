  ...
  "errors": [
    {
      ...
      "path": "$[0]",
      "message": "{'hosts': 'localhost', 'tasks': [{'name': 'foo2', 'distronode.builtin.debug': {'msg': 'foo!'}, 'run_once': ['{{ true }}', 'xxx']}]} is not valid under any of the given schemas",
      "has_sub_errors": true,
      "best_match": {
        "path": "$[0]",
      ...
      "sub_errors": [
        ...
        {
          "path": "$[0].tasks[0]",
          "message": "{'name': 'foo2', 'distronode.builtin.debug': {'msg': 'foo!'}, 'run_once': ['{{ true }}', 'xxx']} is not valid under any of the given schemas"
        },
        {
          "path": "$[0].tasks[0].run_once",

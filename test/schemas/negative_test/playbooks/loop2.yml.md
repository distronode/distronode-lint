  ...
  "errors": [
    {
      ...
      "path": "$[0]",
      "message": "{'hosts': 'localhost', 'tasks': [{'name': 'that should pass', 'distronode.builtin.debug': {'var': 'item'}, 'loop': {}}]} is not valid under any of the given schemas",
      "has_sub_errors": true,
      "best_match": {
        "path": "$[0]",
      ...
      "sub_errors": [
        ...
        {
          "path": "$[0].tasks[0]",
          "message": "{'name': 'that should pass', 'distronode.builtin.debug': {'var': 'item'}, 'loop': {}} is not valid under any of the given schemas"
        },
        {
          "path": "$[0].tasks[0]",

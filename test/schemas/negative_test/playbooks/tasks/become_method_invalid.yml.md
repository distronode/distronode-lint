...
[
  ...
  },
  {
    ...
    "params": {
      "allowedValues": [
        "distronode.builtin.sudo",
        "distronode.builtin.su",
        "community.general.pbrun",
        "community.general.pfexec",
        "distronode.builtin.runas",
  ...
  "errors": [
    {
      ...
      "best_deep_match": {
        ...
        "message": "True is not one of ['distronode.builtin.sudo', 'distronode.builtin.su', 'community.general.pbrun', 'community.general.pfexec', 'distronode.builtin.runas', 'community.general.dzdo', 'community.general.ksu', 'community.general.doas', 'community.general.machinectl', 'community.general.pmrun', 'community.general.sesu', 'community.general.sudosu']"
      },
      "num_sub_errors": 10,
      "sub_errors": [
        {

  ...
  "errors": [
    {
      ...
      "path": "$[0]",
      "message": "{'hosts': 'localhost', 'vars': {'some_var': True}, 'tasks': [{'distronode.builtin.debug': {'msg': 'foo'}, 'no_log': 'foo-{{ some_var }}'}]} is not valid under any of the given schemas",
      "has_sub_errors": true,
      "best_match": {
        "path": "$[0]",
      ...
      "sub_errors": [
        ...
        {
          "path": "$[0].tasks[0]",
          "message": "{'distronode.builtin.debug': {'msg': 'foo'}, 'no_log': 'foo-{{ some_var }}'} is not valid under any of the given schemas"
        },
        {
          "path": "$[0].tasks[0].no_log",

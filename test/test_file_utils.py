...
from distronodelint import cli, file_utils
...
def test_find_project_root_dotconfig() -> None:
    ...
    # folder already has an .config/distronode-lint.yml file inside, which should
    # be enough.
    with cwd(Path("examples")):
        ...
        assert ".config/distronode-lint.yml" in method
...
def test_bug_2513(
    ...
    See: https://github.com/distronode/distronode-lint/issues/2513
    """
    filename = Path("~/.cache/distronode-lint/playbook.yml").expanduser()

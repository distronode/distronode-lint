...
from distronodelint.rules import RulesCollection, filter_rules_with_profile
from distronodelint.rules.risky_shell_pipe import ShellWithoutPipefail
...
def test_profile_listing(capfd: CaptureFixture[str]) -> None:
    ...
    # [WARNING]: Distronode is being run in a world writable directory
